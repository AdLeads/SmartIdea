...
export class TagsService {
  ...
  posttagproject(idproject: number, tag: Tag) {
    return this.http.post(
      `http://localhost:8080/tags/projects/${idproject}`,
      tag
    );
  }
  ...
  addprojecttotag(idproject: number, tag: Tag) {
    return this.http.post(
      `http://localhost:8080/tags/projects/${idproject}/add`,
      tag
    );
  }
  deleteprojecttotag(tagid: number, projectid: number) {
    ...
    return this.http.delete(
      `http://localhost:8080/tags/${tagid}/project/${projectid}`,
      options
    );
  }
  ...
  deleteusertag(tagid: number, userid: number) {
    ...
    let options = { params: httpParams };
    return this.http.delete(
      `http://localhost:8080/tags/${tagid}/user/${userid}`,
      options
    );
  }
}
