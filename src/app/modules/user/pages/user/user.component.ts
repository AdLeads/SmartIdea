...
import { EditSkillComponent } from 'src/app/modules/projects/components/dialogs/edit-skill/edit-skill.component';
import { CreateSkillComponent } from 'src/app/modules/projects/components/dialogs/create-skill/create-skill.component';
...
export class UserComponent implements OnInit {
  ...
  remove(tag: Tag): void {
    ...
    if (index >= 0) {
      ...
      this.tagSerive
        .deleteusertag(tag.tagId, iduser)
        .subscribe((tag) => console.log('Delete successful'));
    }
  }
  ...
  selected(event: MatAutocompleteSelectedEvent): void {
    ...
    if (!this.taagrept(tag)) {
      this.tags.push(tag);
      this.tagSerive
        .addusertotag(iduser, tag)
        .subscribe((value) => console.log('added'));
